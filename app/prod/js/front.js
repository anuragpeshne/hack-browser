...
var hack_browser_front = {conf:{}};
hack_browser_front.conf.setting = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "my-env", "my-env", -157811641), "this-is-prod"], null);
hack_browser_front.core = {};
"undefined" === typeof hack_browser_front.core.app_state && (hack_browser_front.core.app_state = cljs.core.atom.call(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "message", "message", -406056002), "Hello Minimum app world!"], null)));
hack_browser_front.core.mount_root = function(a) {
  return document.getElementById("app").innerHTML = (new cljs.core.Keyword(null, "my-env", "my-env", -157811641)).cljs$core$IFn$_invoke$arity$1(a);
};
hack_browser_front.core.init_BANG_ = function(a) {
  return hack_browser_front.core.mount_root.call(null, a);
};
hack_browser_front.init = {};
cljs.core.enable_console_print_BANG_.call(null);
hack_browser_front.init.start_descjop_BANG_ = function() {
  return hack_browser_front.core.init_BANG_.call(null, hack_browser_front.conf.setting);
};
hack_browser_front.init.start_descjop_BANG_.call(null);
